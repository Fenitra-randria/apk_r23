...
@Component({
  selector: 'app-list-voiture-dispo',
  templateUrl: './list-voiture-dispo.page.html',
  styleUrls: ['./list-voiture-dispo.page.scss'],
})
export class ListVoitureDispoPage implements OnInit {
