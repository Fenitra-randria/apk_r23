...
@Component({
  selector: 'app-if-loueur-voiture',
  templateUrl: './if-loueur-voiture.page.html',
  styleUrls: ['./if-loueur-voiture.page.scss'],
})
export class IfLoueurVoiturePage implements OnInit {
  image: any;
  Recto: any;
  Recto1: any;
  Verso: any;
