...
@Component({
  selector: 'app-if-proprietaire-vehicule',
  templateUrl: './if-proprietaire-vehicule.page.html',
  styleUrls: ['./if-proprietaire-vehicule.page.scss'],
})
export class IfProprietaireVehiculePage implements OnInit {
  image: any;
  Recto: any;
  Recto1: any;
  Verso: any;
