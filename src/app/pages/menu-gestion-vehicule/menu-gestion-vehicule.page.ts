...
@Component({
  selector: 'app-menu-gestion-vehicule',
  templateUrl: './menu-gestion-vehicule.page.html',
  styleUrls: ['./menu-gestion-vehicule.page.scss'],
})
export class MenuGestionVehiculePage implements OnInit {
